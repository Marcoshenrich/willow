    ...
    <div className="User-Show-Page">  
      ...
      <div className="USP-Favorites">
        ...
        <div className="USP-Favorited-Carousel">
          <div className="USP-Carousel-Button" id="USP-Carousel-Button-Left"><BsChevronLeft className="USP-Carousel-Button-Icon" /></div>
          {placeListingModules()}
          <div className="USP-Carousel-Button" id="USP-Carousel-Button-Right"><BsChevronRight className="USP-Carousel-Button-Icon" /></div>
        </div>
      </div>
    </div>
  )
